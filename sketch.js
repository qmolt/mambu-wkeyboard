...
//p5----------------------------------------------------------------------------
function preload(){
	loadJSON('/assets/struc_scales.json', data => scales = data);
	//screenFont = loadFont('/assets/maker-mono.ttf', fontRead); 
	screenFont = loadFont('/assets/Gest-Regular.ttf', fontRead);
